...
(0, ava_1.default)('greet unknown user', t => {
    const { lastFrame } = (0, ink_testing_library_1.render)(<app_js_1.default name={undefined}/>);
    t.is(lastFrame(), `Hello, ${chalk_1.default.green('Stranger')}`);
});
(0, ava_1.default)('greet user with a name', t => {
    const { lastFrame } = (0, ink_testing_library_1.render)(<app_js_1.default name="Jane"/>);
